...
export default class Quaternion {
    ...
    setFromUnitVectors(vFrom: Vec3, vTo: Vec3) {
    ...
    angleTo(q: Quaternion) {
        ...
        return 2 * Math.acos(Math.abs(Math.max(-1, Math.min(this.dot(q), 1))))
    ...
    /** retuns an array including all the components */
    ...
    *[Symbol.iterator]() {
    ...
    public static slerpFlat(dst: Array<any>, dstOffset: number, src0: Array<number>, srcOffset0: number, src1: Array<number>, srcOffset1: number, t: number) {
    ...
    public static multiplyQuaternionsFlat(dst: Array<number>, dstOffset: number, src0: Array<number>, srcOffset0: number, src1: Array<number>, srcOffset1: number) {
