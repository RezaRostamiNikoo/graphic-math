...
export default class Mat4 {
     ...
     *          | 0  0  0  0 |
     *          | dx dy dz 1 |
     * @param {number} theta in radian - this angle means that rotates the matrix clockwise
     * @returns {Mat4}
     */
    ...
    /**
     * it rotates points or ... `clockwise` (right hand rule) and rotates coordinate system `counter clockwise`
     * @example
     * | 1  0  0  0 |
     * | 0 +c +s  0 |
     * | 0 -s +c  0 |
     * | 0  0  0  1 |
     * @param {number} theta in radian - this angle means that this matrix is to rotate objects clockwise or rotate the coordinate system counter clockwise 
     * @returns {Mat4}
     */
