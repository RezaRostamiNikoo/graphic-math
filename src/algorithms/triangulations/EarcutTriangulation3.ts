...
//         this.data = this.getFlat(this.vertices);
...
//             [
//                 ...vertices.map((val, i) => new Vertex3(val.clone())),
//                 ...holes.flat().map((val, i) => new Vertex3(val.clone()))
//             ],
//             triangles
//         );
...
//     get normal(): Vec3 {
//         const result = this.vertices[1].clone().sub(this.vertices[0].clone())
//             .cross(this.vertices[2].clone().sub(this.vertices[0].clone())).normalize();
